...
print('number of blocks in the block chain',number_of_blocks)
...
print('previous hash code of the first block',blockchain.chain[1]['previous_hash'])




if blockchain.chain[0]['Current_hash']==blockchain.chain[1]['previous_hash']:
    print('current hash of genesis is equal to previous hash of the next block hence the transaction is valid')
else:
